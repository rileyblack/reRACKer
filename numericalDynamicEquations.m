...
m1 = 511.48;                                                                %mass of link 1 in pounds
m2 = 377.69;                                                                %mass of link 2 in pounds
m3 = 112.37;                                                                %mass of link 3 in pounds

%defining physical manipulator link CoMs in SolidWorks Model
swCoM1 = [0,  22.93, 0];                                                    %SolidWorks link 1 CoM WRT part [x, y, z] frame
swCoM2 = [30.38, 0, 0];                                                     %SolidWorks link 2 CoM WRT part [x, y, z] frame
swCoM3 = [0, 16, 0];                                                        %SolidWorks link 3 CoM WRT part [x, y, z] frame

%defining physical manipulator link inertias in SolidWorks Model
swI1 = [121003.37, 9699.46, 120816.09];                                     %SolidWorks link 1 inertia WRT assembly [x, y, z] frame
swI2 = [4094.23, 120349.15, 120283.60];                                     %SolidWorks link 2 inertia WRT assembly [x, y, z] frame
swI3 = [9926.04, 674.22, 9926.04];                                          %SolidWorks link 3 inertia WRT assembly [x, y, z] frame
...
%--------------------------------------------------------------------------
%calculating numeric dynamic equations
%--------------------------------------------------------------------------
